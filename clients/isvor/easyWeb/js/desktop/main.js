require.config({
    ...
    paths: {
        ...
        CPstandard:'../../../../../vendor/components/CPstandard/standard'
        ...
        namespace: {
            "overrides": {
                ...
                "resources": {
                    ...
                    "capaIntroducao": {
                        "baseURL": "resources/capaIntroducao",
                        "paths": [
                            "player",
                            "text!template.html"
                        ]
                    ...
                    "listaOrdenada": {
                        "baseURL": "resources/listaOrdenada",
                        "paths": [
                            "text!template.html"
                        ]
                    },
                    ...
                    "telaNavegacao": {
                        "baseURL": "resources/telaNavegacao",
                        "paths": [
                            "player",
                            "text!template.html"
                        ]
